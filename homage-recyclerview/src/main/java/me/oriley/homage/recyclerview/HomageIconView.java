...
public class HomageIconView extends CardView {

    private static final String TAG = HomageIconView.class.getSimpleName();
    ...
    public HomageIconView(@NonNull Context context) {
        this(context, null);
    }

    public HomageIconView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HomageIconView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(@NonNull Context context) {
        View.inflate(context, R.layout.homage_icon_view, this);

        mIconView = (ImageView) findViewById(R.id.homage_icon_view_image_view);
        mTitleView = (TextView) findViewById(R.id.homage_icon_view_title_view);
        mSummaryView = (TextView) findViewById(R.id.homage_icon_view_summary_view);
        mWebButton = (ImageView) findViewById(R.id.homage_icon_view_web_button);
