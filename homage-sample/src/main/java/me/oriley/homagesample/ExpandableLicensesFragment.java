...
import me.oriley.homage.recyclerview.HomageExpandableAdapter;

@SuppressWarnings("WeakerAccess")
public final class ExpandableLicensesFragment extends RecyclerViewFragment {
    ...
    public RecyclerView.Adapter createAdapter() {
        ...
        return new HomageExpandableAdapter(homage);
    }
